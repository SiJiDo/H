...
![截屏2021-11-22 上午9.35.11](images/截屏2021-11-22 上午9.35.11.png)
...
![截屏2021-11-22 上午10.48.25](images/截屏2021-11-22 上午10.48.25.png)
...
![截屏2021-11-22 上午10.49.26](images/截屏2021-11-22 上午10.49.26.png)
...
![截屏2021-11-22 上午10.55.04](images/截屏2021-11-22 上午10.55.04.png)
...
![截屏2021-11-22 上午10.50.42](images/截屏2021-11-22 上午10.50.42.png)

#### 定时模块

定时模块主要作用是，比如一个src项目需要每个月扫一次，则会自动重新扫描，发现新资产并记录

![截屏2021-11-22 上午10.52.03](images/截屏2021-11-22 上午10.52.03.png)
...
![截屏2021-11-22 下午3.34.19](images/截屏2021-11-22 下午3.34.19.png)

添加了后进入项目详细点击开始扫描， 暂停扫描此处是中断扫描，导出结果会保存成Excel

![截屏2021-11-22 下午3.34.44](images/截屏2021-11-22 下午3.34.44.png)
...
![截屏2021-11-22 下午3.38.32](images/截屏2021-11-22 下午3.38.32.png)

#### 端口

![截屏2021-11-22 下午3.40.03](images/截屏2021-11-22 下午3.40.03.png)

#### 站点

设置了标记按钮，如果浏览了该站点，可以点击未标记，该条信息会自动跑到列表最后，可以通过该方式来过滤已经看过的站点

![截屏2021-11-22 下午3.41.40](images/截屏2021-11-22 下午3.41.40.png)

点击标记后，跑到列表末尾

![截屏2021-11-22 下午3.43.06](images/截屏2021-11-22 下午3.43.06.png)

点击详细，集成了该站点的路径扫描和漏洞扫描的信息

![截屏2021-11-22 下午3.44.11](images/截屏2021-11-22 下午3.44.11.png)

![截屏2021-11-22 下午3.44.20](images/截屏2021-11-22 下午3.44.20.png)

### 路径扫描

路径扫描结果如下

![截屏2021-11-22 下午3.45.42](images/截屏2021-11-22 下午3.45.42.png)

### 漏洞扫描

nuclei分等级，有一个漏洞等级的选项卡，该选项卡如果是nuclei扫描的话，会返回poc的等级，如果是xray扫描的话，不会划分等级统一归为xray

![截屏2021-11-22 下午3.46.58](images/截屏2021-11-22 下午3.46.58.png)



### 备案信息查询

调用了https://github.com/canc3s/cSubsidiary， 该工具会根据天眼查查询第一个公司并获取子域名，经过我的改良，实现了通过关键字获取子公司和备案域名信息
...
![截屏2021-11-22 下午4.06.52](images/截屏2021-11-22 下午4.06.52.png)
...
![截屏2021-11-22 下午4.10.06](images/截屏2021-11-22 下午4.10.06.png)

碰撞了后有记录，点击后会显示碰装钱的域名和ip，如果有结果在右侧会出来，反之没有成功则不会显示

![截屏2021-11-22 下午4.22.20](images/截屏2021-11-22 下午4.22.20.png)
...
![截屏2021-11-22 下午4.34.58](images截屏2021-11-22 下午4.34.58.png)
