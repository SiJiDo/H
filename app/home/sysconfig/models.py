...
class Sysconfig(db.Model):
    ...
    config_subdomain = Column(Boolean, default=False)   #是否发送今日新域名
    config_port = Column(Boolean, default=False)   #是否发送今日新端口
    config_http = Column(Boolean, default=False)   #是否发送今日新站点
