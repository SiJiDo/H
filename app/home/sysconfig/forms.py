...
class SysconfigForm(FlaskForm):
    ...
    config_subdomain = BooleanField('子域名推送',default=False)   #是否发送今日新域名
    config_port = BooleanField('端口推送',default=False)   #是否发送今日新端口
    config_http = BooleanField('站点推送',default=False)   #是否发送今日新站点
